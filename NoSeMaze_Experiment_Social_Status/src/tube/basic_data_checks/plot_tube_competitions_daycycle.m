function plot_tube_competitions_daycycle(data_dir,save_dir,cohortsTbl)
%%
...
exportgraphics(gcf, fullfile(save_dir,'tube_competitions_daycycle.pdf'),'ContentType','vector','BackgroundColor','none');

% export source data
writetable(table(h.BinCounts',h.Values','Variablenames',{'BinCounts','BinProp'}),fullfile(save_dir,'SourceData_tube_competitions_daycycle.xlsx'));
